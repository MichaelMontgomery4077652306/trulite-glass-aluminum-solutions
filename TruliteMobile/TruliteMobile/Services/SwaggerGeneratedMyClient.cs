namespace TruliteMobile.Services
{
...

    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<ApiResponseOfMyInfoViewModel> GetInfoAsync(CustomerContext context,
            System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/AX/My/GetInfo");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var objectResponse_ =
                                await ReadObjectResponseAsync<ApiResponseOfMyInfoViewModel>(response_, headers_)
                                    .ConfigureAwait(false);
                        ...
                        return default(ApiResponseOfMyInfoViewModel);
                    }
                    finally
                    {
                        if (response_ != null)
